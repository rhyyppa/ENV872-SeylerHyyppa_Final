...
#Join the SVI_prcessed attributes to the county spatial features
...
SW_FacilityList_sf <- read_csv('Z:/ENV872/ENV872-SeylerHyyppa_Final/Data/Processed/SW_FacilityList_processed.csv') %>% 
