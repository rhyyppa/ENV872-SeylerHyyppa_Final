...
write.csv(SW_FacilityList_processed, row.names = FALSE, file = "Z:/ENV872/ENV872-SeylerHyyppa_Final/Data/Processed/SW_FacilityList_processed.csv")
...
#join counties sf/svi dataframe with processed SW_Facility data
counties_sf_svi_SW_join <- counties_sf_svi %>% 
  left_join(SW_FacilityList_processed, by = c("NAME" = "County"))


#writing csv to save wrangled data as a csv in processed folder 
write.csv(counties_sf_svi_SW_join, row.names = FALSE, file = "Z:/ENV872/ENV872-SeylerHyyppa_Final/Data/Processed/SVI_SW_sf_processed.csv")

read.csv("Z:/ENV872/ENV872-SeylerHyyppa_Final/Data/Processed/SVI_SW_sf_processed.csv")
