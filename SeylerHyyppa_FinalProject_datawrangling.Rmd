...
SW_test <- read.csv("./Data/Raw/SW_FacilityList_actual.csv", stringsAsFactors = TRUE) %>%
  filter(Waste_Type == 'CD')
...
SW_FacilityList_CD_geo <- SW_test %>%
...
write.csv(SW_FacilityList_CD_complete, row.names = FALSE, file = "Z:/ENV872/ENV872-SeylerHyyppa_Final/Data/Processed/SW_Facility_Processed.csv")
