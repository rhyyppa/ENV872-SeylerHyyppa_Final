...
Once the two data sets had been processed and converted into a spatial data frame, we conducted an exploratory analysis of our data visually using maps to display counties and census tracts, as well as construction and demolition landfill locations for the state of North Carolina. We used both the 'ggplot' and 'mapview' packages to visualize this data.
...
Additionally, we calculated the percentage of poverty and low-income households in each county to analyze the distribution of this data for the state of North Carolina. We did this by dividing the total population by the number of low-income or minority households in each county. Then we created a chart of the top 10 counties ranked by rates of poverty and minority. We performed the same exploratory analysis on census tracts for a more localized and higher-resolution understanding of how this data is distributed across North Carolina. 
