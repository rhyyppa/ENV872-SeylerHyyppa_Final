...
Finally, we created two separate lollipop plots using the 'ggplot' package to visualize and explore the relationship between counties and percentages of both poverty and minority in North Carolina. 
...
```{r fig.cap = Percent of Minority by County}
...
```{r fig.cap = Map of Low-Income Percentages and C&D Landfills for North Carolina}
mapview(counties_sf_svi_processed, 
        zcol = 'Percent_MINRTY', 
        col.regions = brewer.pal(2, 'RdBu')) + 
  mapview(landfill_sites_sf, cex = 3, col.regions="green")
...
The next step of our analysis, was exploring the relationship between 
